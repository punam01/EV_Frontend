...
const Bmw_m4_f82 = ({ props, exteriorColor,interiorColor,rimColor,windowGlass}) => {
 ...
 // console.log("MATERIALS",materials)
  ...
  const windowGlassMaterials = {
    temperedGlass: new THREE.MeshPhysicalMaterial({
    ...
    laminatedGlass: new THREE.MeshPhysicalMaterial({
    ...
    <group {...props} dispose={null}>
      <group scale={0.01}>
        ...
        <group position={[74.986, 37.323, 130.31]} rotation={[-Math.PI / 2, 0, 0]} scale={106.747}>
          <mesh geometry={nodes.ARm4_vt_wheel_ARm4_common_black_0.geometry} material={rimMaterial} />
        ...
        <group position={[74.986, 37.323, -150.797]} rotation={[-Math.PI / 2, 0, 0]} scale={106.747}>
          <mesh geometry={nodes.ARm4_vt_wheel001_ARm4_common_black_0.geometry} material={rimMaterial} />
        ...
        <group position={[-74.727, 37.323, 130.31]} rotation={[-Math.PI / 2, 0, 0]} scale={[-106.747, 106.747, 106.747]}>
          <mesh geometry={nodes.ARm4_vt_wheel002_ARm4_common_black_0.geometry} material={rimMaterial} />
        ...
        <group position={[-74.727, 37.323, -150.797]} rotation={[-Math.PI / 2, 0, 0]} scale={[-106.747, 106.747, 106.747]}>
          <mesh geometry={nodes.ARm4_vt_wheel003_ARm4_common_black_0.geometry} material={rimMaterial} />
        ...
        <mesh geometry={nodes.ARm4_sideglass_L_tinted_ARm4_glass_tinted_0.geometry} material={getWindowGlassProps()} rotation={[-Math.PI / 2, 0, 0]} scale={100} />
...
useGLTF.preload('../../public/assets/models/bmw_m4_f82.glb')
export default Bmw_m4_f82;