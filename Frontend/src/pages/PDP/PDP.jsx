...
const PDP = () => {
  ...
  const handleBooking = () => {
    navigate('/prebooking', { car });
  };

  return (
    <div className="pdp-container">
      <div className="pdp-container__left__section">
        <CarouselComponent />
      </div>
      <div className="pdp-container__right__section">
        <h1 className='pdp-container__right__section__h1'>{car.modelId}</h1>
        <h4 className='pdp-container__right__section__h3'>{car.modelId} Rear Wheel Drive</h4>
        ...
        <h1 className='pdp-container__right__section__h1'>Vehicle Details</h1>
        <ul className='pdp-container__right__section__ul'>
          <li className='pdp-container__right__section__li'>
          ...
          <li className='pdp-container__right__section__li'>
            ...
            {car.seatingCapacity} Seating Interior</li>
          <li className='pdp-container__right__section__li'>
            ...
            </svg>Cargo Capacity: {car.cargoCapacity} cu ft</li>
          <li className='pdp-container__right__section__li'>
            ...
            </svg>{car.steering} Steering Wheel</li>
          <li className='pdp-container__right__section__li'>
            ...
            </svg>Autopilot: {car.autopilot ? 'Yes' : 'No'}</li>
        </ul>
        <div className="pdp-container__btn-grp">
          <p className="pdp-container__right__section__book-now">Book now</p>
          <button className='pdp-container__btn' onClick={handleBooking}>
