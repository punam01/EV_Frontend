                ...
                {locations.map(location => (
                    ...
                    >
                        ...
                        <p className="location-container__contact">
                            <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7" fill="currentColor" class="bi bi-telephone-forward" viewBox="0 0 16 16">
                            ...
                            <span>{location.contact.replace('+','')}</span>
                        </p>
                    </div>
                ))}
            </div>
